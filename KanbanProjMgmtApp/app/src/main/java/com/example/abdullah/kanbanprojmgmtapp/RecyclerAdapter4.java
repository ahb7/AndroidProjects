...
public class RecyclerAdapter4 extends RecyclerView.Adapter<RecyclerAdapter4.RecycleViewHolder> {

    String[] taskNames, taskPrios;
    //private final View.OnClickListener mOnClickListener = new View.OnClickListener();

    public RecyclerAdapter4(String[] taskNames, String[] taskPrios) {
    ...
    public static class RecycleViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                ...
                Intent intent = new Intent(context, EditAnswer.class);
